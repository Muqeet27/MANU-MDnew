...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Manu-MD&JPsggTwa#oemTgKhTBAw5a93DyXU-Bht72Jg6XYWS3pLq-fEBdHY' : process.env.SESSION_ID,
...
MOROCCO_BLOCK: process.env.MOROCCO_BLOCK === undefined ? 'true' : process.env.MOROCCO_BLOCK,
